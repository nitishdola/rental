<div class="form-group {{ $errors->has('name') ? 'has-error' : ''}}">
  ...
  <div class="col-md-10">
    {!! Form::text('monthyear', null, ['class' => 'monthpicker form-control required', 'id' => 'monthpicker', 'data-date-format' => "mm/yyyy",  'data-date-viewmode' => "years" , 'data-date-minviewmode' => "months", 'placeholder' => 'Bill Month', 'autocomplete' => 'off', 'required' => 'true']) !!}
  </div>
...
<div class="form-group {{ $errors->has('bill_amount') ? 'has-error' : ''}}">
  ...
  <div class="col-md-10">
    {!! Form::number('bill_amount', null, ['class' => 'form-control required', 'id' => 'bill_amount', 'placeholder' => 'Bill Amount', 'autocomplete' => 'off', 'required' => 'true']) !!}
  </div>
